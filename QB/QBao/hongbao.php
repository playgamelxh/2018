...
function dowork($buffer='')
{
	...
	if (!empty($char)) {
		...
		$adb->getPositionAndClick('com.aether.coder.qbao:id/md_buttonDefaultNegative', 1);
		$adb->getPositionAndClick('com.aether.coder.qbao:id/image_close', 1);
